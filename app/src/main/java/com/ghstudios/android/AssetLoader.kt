...
object AssetLoader {
    ...
    @JvmStatic fun localizeHub(hub: QuestHub?) = when (hub) {
        ...
        QuestHub.DAILY -> ctx.getString(R.string.type_hub_daily)
        QuestHub.GDAILY -> ctx.getString(R.string.type_hub_g_daily)
        QuestHub.GEVENT -> ctx.getString(R.string.type_hub_g_event)
        QuestHub.GEXPERIENCE -> ctx.getString(R.string.type_hub_g_experience)
        QuestHub.GGEAR -> ctx.getString(R.string.type_hub_g_gear)
        QuestHub.INA -> ctx.getString(R.string.type_hub_ina)
        QuestHub.SRGUIDE -> ctx.getString(R.string.type_hub_sr_guide)
