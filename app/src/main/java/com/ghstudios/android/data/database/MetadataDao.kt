    ...
    fun queryMonsterMetadata(monsterId : Long): MonsterMetadata? {
        ...
        return cursor.toList {
            ...
            MonsterMetadata(
                    ...
                    hasExRank = meta.and(1) > 0,
                    hasLowRank = meta.and(2) > 0,
                    hasHighRank = meta.and(4)> 0,
                    hasGouRank = meta.and(8)> 0,
                    hasGRank =  meta.and(16)>0,
                    hasZ1Rank =  meta.and(32)>0,
                    hasZ2Rank =  meta.and(64)>0,
                    hasZ3Rank =  meta.and(128)>0,
                    hasZ4Rank =  meta.and(256)>0
            )
        }.firstOrNull()
    }
