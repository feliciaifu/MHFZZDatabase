...
class DataManager private constructor(private val mAppContext: Context) {
    ...
    fun getArmorUpgrades(id: Long, type: String): ArmorUpgradeCursor {
        return itemDao.queryArmorUpgrades(id, type)
    }
    ...
    /* Get store offers on item id */
    fun queryOffersOnItemID(id: Long): StoreOfferCursor {
        return mHelper.queryOffersOnItemID(id)
    }
    ...
    /********************************* BENTO QUERIES  */
    /* Get a Cursor that has a list of all Bento */

    fun queryBentoMetadata(id: Long): BentoMetadata? {
        return metadataDao.queryBentoMetadata(id)
    }

    fun queryBentos(searchTerm: String): BentoCursor {
        return mHelper.queryBentos()
    }

    /* Get a specific Item */
    fun getBento(id: Long): Bento? {
        return mHelper.queryBento(id)
    }

    fun getBentoRecipes(id: Long): List<Bento>? {
        return mHelper.queryBentoRecipes(id)
    }

    fun queryRecipesOnItemID(id: Long): BentoCursor {
        return mHelper.queryRecipesOnItemID(id)
    }
    ...
    fun queryAllMonsters(): MonsterCursor {
        return monsterDao.queryMonsters(null)
    }

    /* Get an array of Quest based on hub */
    fun queryMonsterArrayType(): List<Monster> {
        return this.queryMonsterType().toList { it.monster }
    }

    /* Get a Cursor that has a list of Quest based on hub */
    fun queryMonsterType(): MonsterCursor {
        return monsterDao.queryMonsterByType()
    }
